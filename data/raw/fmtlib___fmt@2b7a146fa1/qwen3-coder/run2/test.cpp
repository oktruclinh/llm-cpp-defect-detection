...
TEST(FormatTest, GroupingEdgeCases) {
  ...
  EXPECT_EQ(result3, "1,2,3,4,5,6,7,8,9,0");
  ...
  std::string result5 = fmt::format("{:L}", 999999999999999999LL);
  EXPECT_EQ(result5, "999,999,999,999,999,999");
}